...
class RecipeView {
    ...
    #data;
    #errorMessage = 'No recipe found. Please try another one!';
    #successMessage = '';
    render(data) {
        this.#data = data;
    ...
    #generateMarkup() {
        ...
        <img src=${this.#data.img_url} alt=${this.#data.title
            } class="recipe__img" />
        ...
        <div class="recipe__info">
            ...
            <span class="recipe__info-data recipe__info-data--minutes">${this.#data.cooking_time
            }</span>
